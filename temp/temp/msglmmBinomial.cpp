...
double dBinomMulti(mat Y, mat Ntrials, List X, List M, mat offset, mat beta, 
                   mat Psi){
...
vec psiSbinom(mat Psi, int num, double tunep, vec Y, vec Ntrials, mat X, mat M, 
  ...
  vec psi     = Psi.col(num);
  vec psiProp = Rcpp::rnorm(q, 0.0, tunep);
...
// [[Rcpp::export]]
SEXP msglmmBinomial(int iterations, mat Y, mat Ntrials, List X, List M, mat offset, vec sigmab, 
                    vec sigmas, double taub, mat beta0, mat Psi0, mat Sigma0, int verbose){
